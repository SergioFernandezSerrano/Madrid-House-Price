...
mhp$house_type <- factor(mhp$house_type, levels = c("planta -1", "bajo", "entreplanta", "planta 1", "planta 2", "planta 3", "planta 4", "planta 5", "planta 6", "planta 7", "planta 8", "planta 9", "planta 10", "planta 11", "planta 12", "planta 13", "planta 14", "planta 15", "planta 16", "planta 17", "planta 18", "planta 19", "planta 20", "casa", "chalet", "semi-sotano", "sotano"))
```

## Tratamiento de datos faltantes

La variable **house_type_2** tiene 469 filas sin datos.
