...
mhp$house_type <- factor(mhp$house_type, levels = c("sotano", "semi-sotano", "casa", "chalet", "planta -1", "entreplanta", "bajo", "planta 1", "planta 2", "planta 3", "planta 4", "planta 5", "planta 6", "planta 7", "planta 8", "planta 9", "planta 10", "planta 11", "planta 12", "planta 13", "planta 14", "planta 15", "planta 16", "planta 17", "planta 18", "planta 19", "planta 20"))
```
...
```{r}
ggplot(mhp_train, aes(house_type_2)) + geom_bar(fill = "#0BB363") + labs(x = "Tipo de vivienda", y = "Nº de viviendas", title = "Nº de viviendas por tipo") + theme(plot.title = element_text(hjust = 0.5))
```
...
```{r}
ggplot(mhp_train, aes(garage)) + geom_bar(fill = "#0BB363") + labs(x = "Garage", y = "Nº de viviendas", title = "Nº de viviendas con garage") + theme(plot.title = element_text(hjust = 0.5))
```

**BARRIO**

```{r include = FALSE}
table(mhp_train$neighborhood)
```

```{r}
ggplot(mhp_train, aes(neighborhood)) + geom_bar(fill = "#0BB363") + labs(x = "Vecindario", y = "Nº de viviendas", title = "Nº de viviendas por vecindario") + theme(plot.title = element_text(hjust = 0.5))
```
...
```{r}
ggplot(mhp_train, aes(district)) + geom_bar(fill = "#0BB363") + labs(x = "Distrito", y = "Nº de viviendas", title = "Nº de viviendas por distrito") + theme(plot.title = element_text(hjust = 0.5))
```
