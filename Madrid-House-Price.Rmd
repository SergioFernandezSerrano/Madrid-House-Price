...
En el caso de Walmart el estudio de características STL nos revela lo siguiente:
...
-   **linearity**: Esta métrica representa la linealidad en los datos. Un valor más alto indica una mayor linealidad en los datos, lo que implica que los datos siguen una tendencia lineal.

-   **curvature**: Esta métrica representa la curvatura en los datos. Se basa en el coeficiente de una regresión cuadrática ortogonal aplicada al componente de tendencia. Un valor más alto indica una mayor curvatura en los datos, lo que implica que los datos tienen una forma más curva o no lineal.
