...
mhp_train_scaled[, c(4,5)] <- scale(mhp_train[, c(4,5)])

mhp_test_scaled <- mhp_test
mhp_test_scaled[, c(4,5)] <- scale(mhp_test[, c(4,5)])
...
clasificador_RNA = h2o.deeplearning(y = "precio_bin",
                                    training_frame = as.h2o(mhp_train_scaled),
...
RNA_y_pred = as.vector(RNA_predictor>0.5)
...
mhp_train_scaled$precio_distrito = as.numeric(factor(mhp_train_scaled$precio_distrito,
                                               levels = c("caro","medio","barato"),
                                               labels = c(1,2,3)))
RNA_dataset = mhp_train_scaled[,c(3,4,5,6,7,10,11,12)]
```
...
Los redultados obtenidos nos revelan lo siguiente:
